...
const FEATURES: TCardProps[] = [
  {
    Icon: DatabaseIcon,
    heading: "Local First",
    body: ["Your data stays on your phone.", "Available Offline"],
  },
  {
    Icon: HourglassIcon,
    heading: "Built-in Timer",
    body: ["Get proper rest between sets.", "Know exactly when to continue."],
  },
  {
    Icon: NotepadTextIcon,
    heading: "Track Progress",
    body: ["See where you started.", "Realize how far you've come!"],
  },
];
