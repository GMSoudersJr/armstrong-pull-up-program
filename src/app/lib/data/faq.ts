...
export const FAQ: TFAQ[] = [
  ...
  },
  {
    ...
    "body": [
      ...
      "You will find that you increase the numbers in the last two sets before you see much improvement in the first three.",
      "Make sure that each set is a maximum effort set."
    ],
  },
  {
    "id": 4,
    ...
    "body": [
      "Pyramid day.",
      "Start the pyramid with one repetition, the next set has two, and the next set has three.",
      "Continue in this fashion until you miss a set (e.g. your last set was four then five, your next set should be six but you only do four repetitions. You missed the set)",
      "Do one more set at maximum effort.",
  ...
  },
  {
    ...
    "body": [
      ...
      "Slide your hands together and palms toward you so your little fingers are 0-4 inches apart and complete three more training sets resting 60 seconds between each set.",
      "Finally do three training sets with a wide overhand grip (palms facing away) resting 60 seconds between each set."
    ],
  },
  {
    "id": 6,
    ...
    "body": [
      ...
      "Rest 60 seconds between each set.",
      "You do training sets until you fail to do a perfect training set.",
      "This day can wind up being the longest training day as you continue with the program because you will find it easy to do lots of training sets.",
  ...
  },
  {
    ...
    "body": [
      ...
      "This may change from week to week.",
      "You can also try to doing weighted pull-ups or a pull-up assist machine for this day."
    ],
  },
  {
    "id": 8,
